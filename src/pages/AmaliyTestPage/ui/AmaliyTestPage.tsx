...
import styles from "./AmaliyTestPage.module.scss";
...
const lekciyalar: Lekciya[] = Array.from({ length: 8 }, (_, i) => ({
  name: `Masala-${i + 1}`,
  file: `/amaliy-masala/masala-${i + 1}.pdf`,
}));

const AmaliyTestPage: React.FC = () => {
